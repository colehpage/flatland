const CONFIG = {
  ...
  commands: [
    ...
    },
    {
      ...
      color: 'linear-gradient(135deg, #006CA4, #006CA4)',
      icon: 'linkedin',
      quickLaunch: true,
    },
    {
    ...
    },
    {
      ...
      color: 'linear-gradient(135deg, #232f3e, #232f3e)',
      icon: 'aws',
      quickLaunch: true,
    },
    {
    ...
    },
    {
      ...
      search: '/search?query={}',
      color: 'linear-gradient(135deg, #fff, #fff)',
      icon: 'nytimes',
      quickLaunch: false,
    },
    {
    ...
    },
    {
      ...
      search: '/explore/tags/{}',
      color: 'linear-gradient(135deg, #405DE6, #E1306C)',
      icon: 'instagram',
      quickLaunch: false,
    },
    {
      ...
      },
      {
        ...
        icon: 'spotify',
        color: 'linear-gradient(135deg, #1DB954, #1DB954)',
      },
      {
        category: 'Download',
        name: '7digital',
