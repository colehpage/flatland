const CONFIG = {
  ...
  commands: [
    ...
    },
    {
      ...
      url: 'https://gmail.com',
      search: '/#search/{}',
      color: 'linear-gradient(to right, #D44638, #D44638 5%, #B23121 5%, #B23121 10%, #EEEEEE 10%, #EEEEEE 15%, #E2E2E2 15%)',
      icon: 'mail',
      quickLaunch: true,
    },
    {
      ...
      color: 'linear-gradient(to right, #4285F4, #4285F4 5%, #DB4437 5%, #DB4437 10%, #F4B400 10%, #F4B400 15%, #0F9D58 15%)',
      icon: 'drive',
      quickLaunch: false,
    },
    {
      ...
      color: 'linear-gradient(to right, #0077b5, #0077b5 5%, #273e4a 5%, #273e4a 10%, #f5f5f5 10%, #f5f5f5 15%, #fff 15%)',
      icon: 'linkedin',
      quickLaunch: true,
    },
    {
      ...
      color: 'linear-gradient(to right, #DD0000, #DD0000 5%, #B40000 5%, #B40000 10%, #2A2B2C 10%, #2A2B2C 15%, #FFF 15%)',
      icon: '',
      quickLaunch: true,
    },
    {
      ...
      color: 'linear-gradient(to right, #000, #000 5%, #706d6d 5%, #706d6d 10%, #a3a3a3 10%, #a3a3a3 15%, #fff 15%)',
      icon: '',
      quickLaunch: true,
    },
    {
      ...
      color: 'linear-gradient(to right, #36C5F0, #36C5F0 5%, #ECB22E 5%, #ECB22E 10%, #2EB67D 10%, #2EB67D 15%, #E01E5A 15%)',
    ...
    },
    {
      ...
      color: 'linear-gradient(to right, #fff, #fff 5%, #C5C5C5 5%, #C5C5C5 10%, #3765D0 10%, #3765D0 15%, #4688F4 15%)',
      icon: '',
      quickLaunch: true,
    },
    {
      ...
      search: '/search?q={}',
      color: 'linear-gradient(to right, #201F1F, #201F1F 5%, #AC5C51 5%, #AC5C51 10%, #F4CAB1 10%, #F4CAB1 15%, #9CDAF0 15%)',
      icon: 'github',
      quickLaunch: true,
    },
    {
      ...
      search: '/search?q={}',
      color: 'linear-gradient(to right, #222426, #222426 5%, #bcbbbb 5%, #bcbbbb 10%, #f48024 10%, #f48024 15%, #fff 15%)',
      icon: 'stackoverflow',
      quickLaunch: true,
    },
    {
      ...
      color: 'linear-gradient(to right, #232f3e, #232f3e 5%, #007eb9 5%, #007eb9 10%, #e47911 10%, #e47911 15%, #fff 15%)',
      icon: 'aws',
      quickLaunch: true,
    },
    {
      ...
      color: 'linear-gradient(to right, #282828, #282828 5%, #ff0000 5%, #ff0000 10%, #f5f5f5 10%, #f5f5f5 15%, #fff 15%)',
      icon: 'youtube',
      quickLaunch: true,
    },
    {
      ...
      color: 'linear-gradient(to right, #000, #000 5%, #282828 5%, #282828 10%, #fff 10%, #fff 15%, #ff0000 15%)',
      icon: 'netflix',
      quickLaunch: true,
    },
    {
      ...
      color: 'linear-gradient(to right, #18161b, #18161b 5%, #0e9bd7 5%, #0e9bd7 10%, #faf9fa 10%, #faf9fa 15%, #6440a4 15%)',
      icon: 'twitch',
      quickLaunch: true,
    },
    {
      ...
      search: '/search?q={}',
      color: 'linear-gradient(to right, #ff4500, #ff4500 5%, #5f99cf 5%, #5f99cf 10%, #cee3f8 10%, #cee3f8 15%, #fff 15%)',
      icon: 'reddit',
      quickLaunch: true,
    },
    {
      ...
      search: '/search?query={}',
      color: 'linear-gradient(to right, #000, #000 5%, #6288a5 5%, #6288a5 10%, #f7f7f7 10%, #f7f7f7 15%, #fff 15%)',
      icon: 'nytimes',
      quickLaunch: true,
    },
    {
      ...
      color: 'linear-gradient(to right, #000, #000 5%, #f5f8fa 5%, #f5f8fa 10%, #fff 10%, #fff 15%, #1CA1F2 15%)',
      icon: 'twitter',
      quickLaunch: true,
    },
    {
      ...
      search: '/explore/tags/{}',
      color: 'linear-gradient(to right, #405DE6, #405DE6 5%, #C13584 5%, #C13584 10%, #F56040 10%, #F56040 15%, #FFDC80 15%)',
      icon: 'instagram',
      quickLaunch: true,
    },
    {
      ...
      color: 'linear-gradient(to right, #181818, #181818 5%, #333333 5%, #333333 10%, #D2D1CD 10%, #D2D1CD 15%, #E8B706 15%)',
      quickLaunch: true,
    },
    {
      category: 'Media',
      ...
      search: '/search?q={}',
      icon: 'soundcloud',
      color: 'linear-gradient(to right, #FF4137, #FF4137 5%, #F5F5F5 5%, #F5F5F5 10%, #FF9533 10%, #FF9533 15%, #FFE9E1 15%)',
      quickLaunch: true,
    },
    {
      category: 'Media',
      ...
      icon: 'spotify',
      color: 'linear-gradient(to right, #000, #000 5%, #F5F5F5 5%, #F5F5F5 10%, #fff 10%, #fff 15%, #1DB954 15%)',
      quickLaunch: true,
    },
    {
      category: 'Download',
      ...
      search: '/search?q={}',
      icon: '7digital',
      color: 'linear-gradient(to right, #07606E, #07606E 5%, #038DA3 5%, #038DA3 10%, #EFEFEF 10%, #EFEFEF 15%, #fff 15%)',
      quickLaunch: true,
    },
    {
      category: 'Download',
      ...
      search: '/search/{}',
      icon: 'piratebay',
      color: 'linear-gradient(to right, #311A07, #311A07 5%, #634428 5%, #634428 10%, #A3734D 10%, #A3734D 15%, #fff 15%)',
      quickLaunch: true,
    },
    {
      category: 'Download',
      ...
      icon: 'yts',
      color: 'linear-gradient(to right, #161616, #161616 5%, #272727 5%, #272727 10%, #919191 10%, #919191 15%, #5EA83C 15%)',
      quickLaunch: true,
    },
  ],
